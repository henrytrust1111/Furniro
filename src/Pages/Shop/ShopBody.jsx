...
const ShopBody = () => {
  ...
  const currentProducts = shopproduct.slice(
    indexOfFirstProduct,
    indexOfLastProduct
  );
          ...
          {currentProducts.map((shopproduct) => (
            ...
            >
              ...
              {shopproduct.discountPercentage > 0 && (
                <span className="text-white absolute bg-[#E97171] w-12 h-12 rounded-full flex items-center justify-center top-4 left-4 ">
                  {shopproduct.discountPercentage}%
                </span>
              )}
              {shopproduct.label && (
                <span className="text-white absolute bg-[#2EC1AC] w-12 h-12 rounded-full flex items-center justify-center top-4 right-4">
                  {shopproduct.label}
                </span>
              )}
            </div>
