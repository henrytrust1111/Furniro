const Warrantycomparison = () => {
  ...
  {/* col 1 */}
         ...
         <div className="grid grid-rows-7 border-r-2 gap-2">
          ...
          <p className="col-start-2 col-end-2 row-start-4 row-end-4 text-xs md:text-sm lg:text-base break-words sm:w-full  flex items-center break-all hyphens-auto">For Warranty Claims or Any Product Related Issues Please Email at furniture.com</p>
