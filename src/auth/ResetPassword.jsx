...
const ResetPassword = () => {
  ...
  const { id } = useParams(); // Assuming the user ID is part of the URL params
          ...
          <form onSubmit={handleResetPassword} className="space-y-1 w-full px-1 sm:!px-6 md:!px-10 lg:!px-20 flex flex-col justify-center items-center">
            ...
            <div className="w-full">
              <button
                ...
                disabled={loading}
              >
                {loading ? <div className="flex"><ImSpinner2 className="mr-2 animate-spin" size={22} /> Resetting... </div> : "Reset Password"}
              </button>
            </div>
          </form>
        </div>
